                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{route('standings-pilots.index')}}">Driver Standings</a></li>
                                <li><a class="dropdown-item" href="{{ route('standings-constructors.index') }}">Constructor Standings</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
